...
class Interface:
    ...
    def __init__(self, digester:Digester, temperature:float=1.0, prior_param:Optional[ProbaParam] = None):
        self.dig = digester
    ...
    def mult_score(
        ...
        **kwargs
        ...
        return par_eval(self.score, pars, parallel=True, solver_method=solver_method, max_step=max_step, min_step=min_step, eps=eps, max_score=max_score, elbow=elbow, **kwargs)
